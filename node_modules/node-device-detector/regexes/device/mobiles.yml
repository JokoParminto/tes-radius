...
# Irbis
Irbis:
  regex: 'TZ(1(?:00|50|84|65|7[35-8]|9[578])|49|7(?:1[467]|2[0156]|37|4[27]|5[23457]|62|72|7[17]|8[1]|9[47])|8(?:[34]1|5[3-7]|6[45]|7[2478]|8[1-5]|9[012])|96[0-9])|TZ(?:one|art|HIT|81L)|(SP(?:0[56]|2[01]|4[1-36]|40[12]|45[345]|50|51[0147]|531|55[012]))[;)\ ]'
  device: 'tablet'
  models:
...
# Telefunken
Telefunken:
  regex: 'TEL-1013GIQA|TF-SP5001|(TF-MID(?:[78]02G|9705RG|7805G|1010G))|(TF-LED(?:65S75T2SU|32S39T2S|32S5[289]T2S|32S70T2S))'
  device: 'tablet'
  models:
    - regex: 'TEL-1013GIQA'
      model: 'Giqa 10.1 3G'
...
# Ritmix
Ritmix:
  regex: '(RMD[-_](?:10(?:2[68]|5[89])|1121|751|726|857|870)|RMP-(?:530|600))[);/ ]'
  device: 'tablet'
  models:
    - regex: 'RMD[-_](10(?:2[68]|5[89])|1121|751|726|857|870)[);/ ]'
      model: 'RMD-$1'
    - regex: 'RMP[-_](530|600)[);/ ]'
      model: 'RMP-$1'
      device: 'smartphone'
